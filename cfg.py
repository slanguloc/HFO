...
cfg.analysis['plotLFP'] = {'plots': ['timeSeries', 'PSD', 'spectrogram'], 'electrodes': [10], 'maxFreq': 400, 'figSize': (8,5), 'saveData': False, 'saveFig': True, 'showFig': False}
...
cfg.sizeZ = 200.0
cfg.scaleDensity = 0.01 #0.075 # Should be 1.0 unless need lower cell density for test simulation or visualization
